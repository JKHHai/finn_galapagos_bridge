...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "AXI_STREAM_NUM_TRANSFERS" -parent ${Page_0}
  ipgui::add_param $IPINST -name "GALAPAGOS_DATA_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "GALAPAGOS_TDEST" -parent ${Page_0}
  ipgui::add_param $IPINST -name "GALAPAGOS_TID" -parent ${Page_0}
...
proc update_PARAM_VALUE.GALAPAGOS_TDEST { PARAM_VALUE.GALAPAGOS_TDEST } {
	# Procedure called to update GALAPAGOS_TDEST when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.GALAPAGOS_TDEST { PARAM_VALUE.GALAPAGOS_TDEST } {
	# Procedure called to validate GALAPAGOS_TDEST
	return true
}

proc update_PARAM_VALUE.GALAPAGOS_TID { PARAM_VALUE.GALAPAGOS_TID } {
	# Procedure called to update GALAPAGOS_TID when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.GALAPAGOS_TID { PARAM_VALUE.GALAPAGOS_TID } {
	# Procedure called to validate GALAPAGOS_TID
	return true
}
...
proc update_MODELPARAM_VALUE.GALAPAGOS_TID { MODELPARAM_VALUE.GALAPAGOS_TID PARAM_VALUE.GALAPAGOS_TID } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.GALAPAGOS_TID}] ${MODELPARAM_VALUE.GALAPAGOS_TID}
}

proc update_MODELPARAM_VALUE.GALAPAGOS_TDEST { MODELPARAM_VALUE.GALAPAGOS_TDEST PARAM_VALUE.GALAPAGOS_TDEST } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.GALAPAGOS_TDEST}] ${MODELPARAM_VALUE.GALAPAGOS_TDEST}
}
