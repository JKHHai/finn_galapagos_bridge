...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_deployment_test_receiving_block is
  ...
  signal \^o_result_tvalid\ : STD_LOGIC;
  ...
  signal r_num_transfers_received : STD_LOGIC;
  ...
  signal r_result_tvalid_i_2_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of r_result_tvalid_i_2 : label is "soft_lutpair0";
begin
...
\r_received_packet[63]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\r_result_pass[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
    )
        port map (
...
\r_result_pass_reg[0]_i_2\: unisim.vcomponents.CARRY8
     port map (
      ...
      CO(5) => \r_result_pass_reg[0]_i_2_n_2\,
...
r_result_tvalid_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
r_result_tvalid_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute X_INTERFACE_PARAMETER of i_clk : signal is "XIL_INTERFACENAME i_clk, ASSOCIATED_RESET i_aresetn, ASSOCIATED_BUSIF i_test_axis:o_result, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN design_1_i_clock, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of i_test_axis_TDATA : signal is "XIL_INTERFACENAME i_test_axis, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN design_1_i_clock, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of o_result_PASS : signal is "xilinx.com:interface:axis:1.0 o_result TDATA";
  attribute X_INTERFACE_PARAMETER of o_result_PASS : signal is "XIL_INTERFACENAME o_result, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 0, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN design_1_i_clock, LAYERED_METADATA undef, INSERT_VIP 0";
begin
