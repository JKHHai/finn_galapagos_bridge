...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_data_width_converter is
  port (
    ...
    r_dwc_output_ready_reg : out STD_LOGIC_VECTOR ( 1 downto 0 );
    r_axis_tlast_0 : out STD_LOGIC;
    i_gp_TLAST_0 : out STD_LOGIC;
    i_axis_TREADY_0 : out STD_LOGIC;
    i_clk : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_data_width_converter is
  ...
  signal r_input_data : STD_LOGIC_VECTOR ( 511 downto 8 );
  ...
  signal r_input_keep : STD_LOGIC_VECTOR ( 63 downto 1 );
  ...
  signal r_output_last_i_15_n_0 : STD_LOGIC;
  signal r_output_last_i_16_n_0 : STD_LOGIC;
  signal r_output_last_i_17_n_0 : STD_LOGIC;
  signal r_output_last_i_18_n_0 : STD_LOGIC;
  ...
  signal w_dwc_output_tdata : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM of \r_axis_tdata[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \r_axis_tdata[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \r_axis_tdata[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \r_axis_tdata[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \r_axis_tdata[4]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \r_axis_tdata[5]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \r_axis_tdata[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \r_axis_tdata[7]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of r_axis_tlast_i_1 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of r_dwc_output_ready_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \r_input_data[504]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \r_input_data[505]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \r_input_data[506]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \r_input_data[507]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \r_input_data[508]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \r_input_data[509]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \r_input_data[510]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \r_input_data[511]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \r_input_keep[63]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \r_output_data[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \r_output_data[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \r_output_data[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \r_output_data[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \r_output_data[4]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \r_output_data[5]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \r_output_data[6]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \r_output_data[7]_i_1\ : label is "soft_lutpair13";
begin
...
r_output_last_i_10: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
r_output_last_i_12: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
r_output_last_i_14: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
r_output_last_i_15: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
r_output_last_i_16: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
r_output_last_i_17: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
r_output_last_i_18: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
r_output_last_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
...
r_output_last_i_4: unisim.vcomponents.LUT6
    generic map(
...
r_output_last_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_galapagos_to_axi_stream_bridge is
  port (
    ...
    i_gp_TDEST : in STD_LOGIC_VECTOR ( 7 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_galapagos_to_axi_stream_bridge is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_r_core_state[0]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \FSM_onehot_r_core_state[1]_i_2\ : label is "soft_lutpair14";
  attribute FSM_ENCODED_STATES : string;
...
dwc: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_data_width_converter
     port map (
      ...
      r_dwc_output_ready_reg(1) => dwc_n_10,
      r_dwc_output_ready_reg(0) => dwc_n_11,
...
\r_dwc_input_valid2_carry__0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\r_dwc_input_valid2_carry__0_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\r_dwc_input_valid2_carry__0_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
r_dwc_input_valid2_carry_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
r_dwc_input_valid2_carry_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
r_dwc_input_valid2_carry_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
r_dwc_input_valid2_carry_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
r_dwc_input_valid2_carry_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
r_dwc_input_valid2_carry_i_6: unisim.vcomponents.LUT5
    generic map(
      INIT => X"09000009"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  port (
    ...
    i_gp_TKEEP : in STD_LOGIC_VECTOR ( 63 downto 0 );
    i_gp_TDEST : in STD_LOGIC_VECTOR ( 7 downto 0 );
    i_gp_TID : in STD_LOGIC_VECTOR ( 7 downto 0 );
    i_gp_TLAST : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute X_INTERFACE_PARAMETER of i_clk : signal is "XIL_INTERFACENAME i_clk, ASSOCIATED_RESET i_aresetn, ASSOCIATED_BUSIF i_gp:o_axis, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN design_1_i_clock, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of i_gp_TLAST : signal is "xilinx.com:interface:axis:1.0 i_gp TLAST";
  attribute X_INTERFACE_PARAMETER of i_gp_TLAST : signal is "XIL_INTERFACENAME i_gp, TDATA_NUM_BYTES 64, TDEST_WIDTH 8, TID_WIDTH 8, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 1, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN design_1_i_clock, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of o_axis_TDATA : signal is "XIL_INTERFACENAME o_axis, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN design_1_i_clock, LAYERED_METADATA undef, INSERT_VIP 0";
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_galapagos_to_axi_stream_bridge
     port map (
      ...
      i_gp_TDEST(7 downto 0) => i_gp_TDEST(7 downto 0),
      i_gp_TKEEP(63 downto 0) => i_gp_TKEEP(63 downto 0),
      i_gp_TLAST => i_gp_TLAST,
      i_gp_TVALID => i_gp_TVALID,
      o_axis_TDATA(7 downto 0) => o_axis_TDATA(7 downto 0),
