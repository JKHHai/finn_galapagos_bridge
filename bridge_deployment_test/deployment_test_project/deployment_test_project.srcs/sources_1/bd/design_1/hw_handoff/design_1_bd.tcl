...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.AXI_STREAM_DATA_WIDTH {56} \
   CONFIG.AXI_STREAM_NUM_TRANSFERS {16} \
  ...
  set_property -dict [ list \
   CONFIG.AXIS_DATA_WIDTH {56} \
   CONFIG.NUM_BITS_PER_TRANSFER {49} \
   CONFIG.NUM_TRANSFERS {16} \
  ...
  set_property -dict [ list \
   CONFIG.AXI_STREAM_DATA_WIDTH {56} \
   CONFIG.GALAPAGOS_NUM_TRANSFERS {2} \
 ] $galapagos_to_axi_str_0

  # Create instance: packet, and set properties
  set packet [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 packet ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0x0000000000000000000000000000049524A09515550D4FFF20EEFFF80F9FFFD0FFFBFA0FFFFF107FFFF207FFFF30BFF5C307E730E0FF1B3C0FCA2F807DACC30BC7D0307FFEFC0BFFE0005FFF000AFFC0000FFD000C824000B24B0006ED2000596600} \
   CONFIG.CONST_WIDTH {784} \
 ] $packet
...
connect_bd_intf_net -intf_net deployment_test_rece_0_o_result [get_bd_intf_pins deployment_test_rece_0/o_result] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
  connect_bd_intf_net -intf_net deployment_test_sour_0_o_test_axis [get_bd_intf_pins axi_stream_to_galapa_0/i_axis] [get_bd_intf_pins deployment_test_sour_0/o_test_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets deployment_test_sour_0_o_test_axis] [get_bd_intf_pins axi_stream_to_galapa_0/i_axis] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets galapagos_to_axi_str_0_o_axis] [get_bd_intf_pins deployment_test_rece_0/i_test_axis] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  ...
  connect_bd_net -net aresetn_dout [get_bd_pins aresetn/dout] [get_bd_pins axi_stream_to_galapa_0/i_aresetn] [get_bd_pins deployment_test_rece_0/i_aresetn] [get_bd_pins deployment_test_sour_0/i_aresetn] [get_bd_pins galapagos_to_axi_str_0/i_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net i_clock_1 [get_bd_pins axi_stream_to_galapa_0/i_clk] [get_bd_pins deployment_test_rece_0/i_clk] [get_bd_pins deployment_test_sour_0/i_clk] [get_bd_pins galapagos_to_axi_str_0/i_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins util_ds_buf_0/IBUF_OUT] [get_bd_pins vio_0/clk]
  connect_bd_net -net packet_dout [get_bd_pins deployment_test_rece_0/i_expected_packet] [get_bd_pins deployment_test_sour_0/i_packet_to_send] [get_bd_pins packet/dout]
