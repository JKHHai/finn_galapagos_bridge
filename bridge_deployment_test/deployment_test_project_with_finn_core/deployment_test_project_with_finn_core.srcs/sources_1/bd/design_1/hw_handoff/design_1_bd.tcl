...
proc create_root_design { parentCell } {
  ...
  set sysclk100 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 sysclk100 ]


  # Create ports

  # Create instance: StreamingFCLayer_Bat_0, and set properties
  set StreamingFCLayer_Bat_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:StreamingFCLayer_Batch_3_memstream:1.0 StreamingFCLayer_Bat_0 ]

  # Create instance: TID_1, and set properties
  set TID_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 TID_1 ]
  set_property -dict [ list \
   CONFIG.CONST_WIDTH {32} \
 ] $TID_1

  # Create instance: TID_2, and set properties
  set TID_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 TID_2 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {2} \
   CONFIG.CONST_WIDTH {32} \
 ] $TID_2
  ...
  # Create instance: axi_stream_to_galapa_0, and set properties
  set axi_stream_to_galapa_0 [ create_bd_cell -type ip -vlnv uoft-hprc:finn_galapagos_bridge:axi_stream_to_galapagos_bridge:1.3 axi_stream_to_galapa_0 ]
  set_property -dict [ list \
   CONFIG.AXI_STREAM_DATA_WIDTH {320} \
   CONFIG.AXI_STREAM_NUM_TRANSFERS {1} \
 ] $axi_stream_to_galapa_0

  # Create instance: debug_core
  create_hier_cell_debug_core [current_bd_instance .] debug_core

  # Create instance: deployment_test_rece_0, and set properties
  set deployment_test_rece_0 [ create_bd_cell -type ip -vlnv uoft-hprc:deployment_test:deployment_test_receiving_block:1.4 deployment_test_rece_0 ]
  set_property -dict [ list \
   CONFIG.AXIS_DATA_WIDTH {320} \
   CONFIG.NUM_BITS_PER_TRANSFER {320} \
   CONFIG.NUM_TRANSFERS {1} \
 ] $deployment_test_rece_0

  # Create instance: deployment_test_sour_0, and set properties
  set deployment_test_sour_0 [ create_bd_cell -type ip -vlnv uoft-hprc:deployment_test:deployment_test_source_block:1.1 deployment_test_sour_0 ]
  set_property -dict [ list \
   CONFIG.AXIS_DATA_WIDTH {8} \
   CONFIG.NUM_BITS_PER_TRANSFER {8} \
   CONFIG.NUM_TRANSFERS {8} \
 ] $deployment_test_sour_0

  # Create instance: expected_output_packet, and set properties
  set expected_output_packet [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 expected_output_packet ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0x00000018000000210000001f0000001f0000001c0000001e00000022000000380000001b00000022} \
   CONFIG.CONST_WIDTH {320} \
 ] $expected_output_packet

  # Create instance: galapagos_to_axi_str_0, and set properties
  set galapagos_to_axi_str_0 [ create_bd_cell -type ip -vlnv uoft-hprc:finn_galapagos_bridge:galapagos_to_axi_stream_bridge:1.2 galapagos_to_axi_str_0 ]
  set_property -dict [ list \
   CONFIG.AXI_STREAM_DATA_WIDTH {320} \
   CONFIG.GALAPAGOS_NUM_TRANSFERS {1} \
 ] $galapagos_to_axi_str_0
  ...
  set_property -dict [ list \
   CONFIG.CONST_VAL {b1011011111111110010011111011101100001101010100001010010000111101} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net CLK_IN_D_0_1 [get_bd_intf_ports sysclk100] [get_bd_intf_pins util_ds_buf_0/CLK_IN_D]
  connect_bd_intf_net -intf_net axi_stream_to_galapa_0_o_gp [get_bd_intf_pins axi_stream_to_galapa_0/o_gp] [get_bd_intf_pins galapagos_to_axi_str_0/i_gp]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_stream_to_galapa_0_o_gp] [get_bd_intf_pins galapagos_to_axi_str_0/i_gp] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
connect_bd_intf_net -intf_net deployment_test_rece_0_o_result [get_bd_intf_pins deployment_test_rece_0/o_result] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
  connect_bd_intf_net -intf_net deployment_test_sour_0_o_test_axis [get_bd_intf_pins StreamingFCLayer_Bat_0/out_V_V] [get_bd_intf_pins axi_stream_to_galapa_0/i_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets deployment_test_sour_0_o_test_axis] [get_bd_intf_pins axi_stream_to_galapa_0/i_axis] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
  connect_bd_intf_net -intf_net deployment_test_sour_0_o_test_axis1 [get_bd_intf_pins StreamingFCLayer_Bat_0/in0_V_V] [get_bd_intf_pins deployment_test_sour_0/o_test_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets deployment_test_sour_0_o_test_axis1] [get_bd_intf_pins StreamingFCLayer_Bat_0/in0_V_V] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net galapagos_to_axi_str_0_o_axis [get_bd_intf_pins deployment_test_rece_0/i_test_axis] [get_bd_intf_pins galapagos_to_axi_str_0/o_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets galapagos_to_axi_str_0_o_axis] [get_bd_intf_pins deployment_test_rece_0/i_test_axis] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]

  # Create port connections
  connect_bd_net -net TID_1_dout [get_bd_pins TID_1/dout] [get_bd_pins axi_stream_to_galapa_0/i_core_TID]
  connect_bd_net -net TID_2_dout [get_bd_pins TID_2/dout] [get_bd_pins axi_stream_to_galapa_0/i_core_TDEST] [get_bd_pins galapagos_to_axi_str_0/i_core_TID]
  connect_bd_net -net aresetn_dout [get_bd_pins StreamingFCLayer_Bat_0/ap_rst_n] [get_bd_pins aresetn/dout] [get_bd_pins axi_stream_to_galapa_0/i_aresetn] [get_bd_pins deployment_test_rece_0/i_aresetn] [get_bd_pins deployment_test_sour_0/i_aresetn] [get_bd_pins galapagos_to_axi_str_0/i_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net expected_output_packet_dout [get_bd_pins deployment_test_rece_0/i_expected_packet] [get_bd_pins expected_output_packet/dout]
  connect_bd_net -net i_clock_1 [get_bd_pins StreamingFCLayer_Bat_0/ap_clk] [get_bd_pins axi_stream_to_galapa_0/i_clk] [get_bd_pins deployment_test_rece_0/i_clk] [get_bd_pins deployment_test_sour_0/i_clk] [get_bd_pins galapagos_to_axi_str_0/i_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins util_ds_buf_0/IBUF_OUT] [get_bd_pins vio_0/clk]
  connect_bd_net -net packet_dout [get_bd_pins deployment_test_sour_0/i_packet_to_send] [get_bd_pins input_packet/dout]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins deployment_test_sour_0/i_enable] [get_bd_pins vio_0/probe_out0]
