...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_1_AXIS_TDEST_WIDTH {32} \
   CONFIG.C_SLOT_1_AXIS_TID_WIDTH {32} \
   ...
   CONFIG.C_SLOT_2_AXIS_TDATA_WIDTH {320} \
   ...
   CONFIG.C_SLOT_4_AXIS_TDATA_WIDTH {320} \
...
connect_bd_intf_net -intf_net Conn4 [get_bd_intf_ports SLOT_4_AXIS] [get_bd_intf_pins g_inst/slot_4_axis]
  ...
  connect_bd_net -net net_slot_1_axis_tdest [get_bd_pins g_inst/m_slot_1_axis_tdest] [get_bd_pins ila_lib/probe5]
  connect_bd_net -net net_slot_1_axis_tid [get_bd_pins g_inst/m_slot_1_axis_tid] [get_bd_pins ila_lib/probe6]
