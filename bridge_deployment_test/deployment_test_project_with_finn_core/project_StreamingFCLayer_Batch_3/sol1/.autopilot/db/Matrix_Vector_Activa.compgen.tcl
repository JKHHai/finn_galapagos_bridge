...
set id 1
set name StreamingFCLayer_Batch_3_StreamingFCLayer_Batch_3_mux_83_8_1_1
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_V_V_TDATA { O 320 vector } out_V_V_TVALID { O 1 bit } out_V_V_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { weight_V_V_TDATA { I 80 vector } weight_V_V_TVALID { I 1 bit } weight_V_V_TREADY { O 1 bit } } \
} "
} else {
