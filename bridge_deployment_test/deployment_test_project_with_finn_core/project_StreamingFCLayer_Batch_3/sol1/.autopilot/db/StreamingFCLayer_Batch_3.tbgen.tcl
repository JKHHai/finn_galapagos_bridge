...
set C_modelArgList {
	...
	{ weights_V_V int 80 regular {axi_s 0 volatile  { weights_V_V Data } }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "in0_V_V", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "in0.V.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "weights_V_V", "interface" : "axis", "bitwidth" : 80, "direction" : "READONLY", "bitSlice":[{"low":0,"up":79,"cElement": [{"cName": "weights.V.V","cData": "uint80","bit_use": { "low": 0,"up": 79},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "out_V_V", "interface" : "axis", "bitwidth" : 320, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":319,"cElement": [{"cName": "out.V.V","cData": "uint320","bit_use": { "low": 0,"up": 319},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "weights_V_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":80, "type": "signal", "bundle":{"name": "weights_V_V", "role": "TDATA" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Matrix_Vector_Activa_fu_28", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Matrix_Vector_Activa_fu_28.StreamingFCLayer_Batch_3_mux_83_8_1_1_U1", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	weights_V_V { axis {  { weights_V_V_TDATA in_data 0 80 }  { weights_V_V_TVALID in_vld 0 1 }  { weights_V_V_TREADY in_acc 1 1 } } }
