...
proc init_gui { IPINST } {
  ...
  set NUM_BITS_PER_TRANSFER [ipgui::add_param $IPINST -name "NUM_BITS_PER_TRANSFER" -parent ${Page_0}]
  set_property tooltip {Number of bits in each AXI-Stream transfer that are populated with data} ${NUM_BITS_PER_TRANSFER}
  set NUM_TRANSFERS [ipgui::add_param $IPINST -name "NUM_TRANSFERS" -parent ${Page_0}]
  set_property tooltip {Number of AXI-Stream Transfers that make up a single AXI-Stream packet} ${NUM_TRANSFERS}
