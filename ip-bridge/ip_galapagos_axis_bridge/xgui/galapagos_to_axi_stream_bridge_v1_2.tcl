...
proc init_gui { IPINST } {
  ...
  set GALAPAGOS_NUM_TRANSFERS [ipgui::add_param $IPINST -name "GALAPAGOS_NUM_TRANSFERS" -parent ${Page_0}]
  set_property tooltip {Number of Galapagos transfers that make up a single Galapagos packet} ${GALAPAGOS_NUM_TRANSFERS}
...
proc update_PARAM_VALUE.GALAPAGOS_NUM_TRANSFERS { PARAM_VALUE.GALAPAGOS_NUM_TRANSFERS } {
	# Procedure called to update GALAPAGOS_NUM_TRANSFERS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.GALAPAGOS_NUM_TRANSFERS { PARAM_VALUE.GALAPAGOS_NUM_TRANSFERS } {
	# Procedure called to validate GALAPAGOS_NUM_TRANSFERS
	return true
}
...
proc update_MODELPARAM_VALUE.GALAPAGOS_NUM_TRANSFERS { MODELPARAM_VALUE.GALAPAGOS_NUM_TRANSFERS PARAM_VALUE.GALAPAGOS_NUM_TRANSFERS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.GALAPAGOS_NUM_TRANSFERS}] ${MODELPARAM_VALUE.GALAPAGOS_NUM_TRANSFERS}
}
